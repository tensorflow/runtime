...
// RUN: bef_executor $(bef_name %s) --work_queue_type=mstd:1 | FileCheck %s --dump-input=always
// RUN: bef_executor $(bef_name %s) --work_queue_type=mstd:2 | FileCheck %s --dump-input=always
// RUN: bef_executor $(bef_name %s) --work_queue_type=mstd:4 | FileCheck %s --dump-input=always
// RUN: bef_executor $(bef_name %s) --work_queue_type=mstd:8 | FileCheck %s --dump-input=always
