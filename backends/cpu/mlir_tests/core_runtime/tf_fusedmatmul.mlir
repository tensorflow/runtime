...
// CHECK: --- Running 'fusedMatMul_bias_relu6_f32'
func @fusedMatMul_bias_relu6_f32() -> !tfrt.chain{
  %ch_epoch = tfrt.new.chain
  %cpu = corert.get_op_handler %ch_epoch "cpu"
...
// CHECK: --- Running 'fusedMatMul_bias_elu_f32'
func @fusedMatMul_bias_elu_f32() -> !tfrt.chain{
  %ch_epoch = tfrt.new.chain
  %cpu = corert.get_op_handler %ch_epoch "cpu"
