...
// CHECK: --- Running 'mul_dense_dense_f32'
func.func @mul_dense_dense_f32() attributes {tfrt.sync} {
  ...
  "tf_sync.Mul.f32"(%operand_0, %operand_1, %result) : (!t.tensor, !t.tensor, !t.tensor)->()
