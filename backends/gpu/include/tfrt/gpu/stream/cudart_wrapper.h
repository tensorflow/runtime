...
// Wraps a cudaError_t into an llvm::ErrorInfo.
using CudartErrorInfo = TupleErrorInfo<CudartErrorData>;
...
#endif  // TFRT_GPU_STREAM_CUDART_WRAPPER_H_
