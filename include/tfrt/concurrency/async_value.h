...
// TODO(b/254083070): migrate to TSL log once moved to TSL.
#include "tfrt/support/logging.h"
// TODO(b/254083070): migrate to TSL AlignedMalloc once moved to TSL.
...
inline void AsyncValue::Destroy() {
  ...
  if (kind() == Kind::kIndirect) {
    ...
    if (was_ref_counted) tfrt::AlignedFree(this);
    return;
  }
